...
import static com.sg.flooringmastery.dao.FlooringMasteryDaoFileImpl.dateString;
...
public class FlooringMasteryDaoMock implements FlooringMasteryDao {
    ...
    public static String dateString = "10102020";
    public static final String DELIMITER = ",";
    public static String ORDER_FILE;
    public static final String EXPORT_FILE = "TestDao/DataExport.txt";
    private Map<Integer, OrderFile> ordersMap = new HashMap<>();
    
    public FlooringMasteryDaoMock(){
        
    }
    
    public FlooringMasteryDaoMock(String testFile){
        ORDER_FILE = testFile;
    }
    ...
    private void loadOrders(String date) throws FloorMasteryDaoException {
        ORDER_FILE = ("TestDao/orders_" + date + ".txt");
        Scanner sc;
        try {
            sc = new Scanner(
                    new BufferedReader(
    ...
    private void exportOrders() throws FloorMasteryDaoException {
        ...
        File[] folder = new File("TestDao").listFiles();
        try {
